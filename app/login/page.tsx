      ...
      <div className="bg-gray-900 border border-gray-800 p-8 rounded-xl shadow-xl w-full max-w-md flex flex-col gap-6">
        ...
        <div className="flex flex-col gap-3">
          <form action={signInWithGoogle}>
            <button className="w-full bg-white text-gray-900 hover:bg-gray-100 font-semibold py-2.5 rounded-lg flex items-center justify-center transition-colors">
          ...
          <form action={signInWithGithub}>
            <button className="w-full bg-[#24292e] text-white hover:bg-[#2f363d] font-semibold py-2.5 rounded-lg flex items-center justify-center transition-colors">
        ...
        <div className="relative flex items-center py-2">
          ...
          <span className="flex-shrink-0 mx-4 text-gray-500 text-sm">Or use email</span>
          <div className="flex-grow border-t border-gray-800"></div>
        </div>
